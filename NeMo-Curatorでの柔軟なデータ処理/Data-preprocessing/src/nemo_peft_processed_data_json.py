"""
このスクリプトは、入力されたJSONL形式のデータを読み込み、タイトルに基づいてプロンプトを生成し、
...
INPUT_FILE = "/workspace/data/mydata/3_decontamination/processed_data.jsonl"
OUTPUT_DIR = "/workspace/data/nemo-peft_processed-data"
